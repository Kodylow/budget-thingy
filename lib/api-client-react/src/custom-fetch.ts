...
/**
 * Register a web-client callback for an expired session. The callback is only
 * invoked for 401 responses; authorization failures (403) are deliberately
 * left to the caller.
 */
