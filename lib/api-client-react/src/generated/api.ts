...
export const getGetReportingDetailUrl = (groupIds: string,
    params?: GetReportingDetailParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/reporting/details/${encodeURIComponent(String(groupIds))}?${stringifiedParams}` : `/api/reporting/details/${encodeURIComponent(String(groupIds))}`
}
 ...
 */
export const getReportingDetail = async (groupIds: string,
    params?: GetReportingDetailParams, options?: RequestInit): Promise<ReportingDetail> => {

  return customFetch<ReportingDetail>(getGetReportingDetailUrl(groupIds,params),
  {
    ...options,
    method: 'GET'
...
export const getGetReportingDetailQueryKey = (groupIds: string,
    params?: GetReportingDetailParams,) => {
    return [
    `/api/reporting/details/${groupIds}`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetReportingDetailQueryOptions = <TData = Awaited<ReturnType<typeof getReportingDetail>>, TError = ErrorType<ApiError | UnauthorizedResponse>>(groupIds: string,
    params?: GetReportingDetailParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getReportingDetail>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetReportingDetailQueryKey(groupIds,params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getReportingDetail>>> = ({ signal }) => getReportingDetail(groupIds,params, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: groupIds !== null && groupIds !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getReportingDetail>>, TError, TData> & { queryKey: QueryKey }
}

export type GetReportingDetailQueryResult = NonNullable<Awaited<ReturnType<typeof getReportingDetail>>>
export type GetReportingDetailQueryError = ErrorType<ApiError | UnauthorizedResponse>
...
export function useGetReportingDetail<TData = Awaited<ReturnType<typeof getReportingDetail>>, TError = ErrorType<ApiError | UnauthorizedResponse>>(
 groupIds: string,
    params?: GetReportingDetailParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getReportingDetail>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetReportingDetailQueryOptions(groupIds,params,options)
...
export const getGetBudgetTeamReportUrl = (poolId: string,
    params?: GetBudgetTeamReportParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/reporting/teams/${encodeURIComponent(String(poolId))}?${stringifiedParams}` : `/api/reporting/teams/${encodeURIComponent(String(poolId))}`
}
 ...
 */
export const getBudgetTeamReport = async (poolId: string,
    params?: GetBudgetTeamReportParams, options?: RequestInit): Promise<ReportingDetail> => {

  return customFetch<ReportingDetail>(getGetBudgetTeamReportUrl(poolId,params),
  {
    ...options,
    method: 'GET'
...
export const getGetBudgetTeamReportQueryKey = (poolId: string,
    params?: GetBudgetTeamReportParams,) => {
    return [
    `/api/reporting/teams/${poolId}`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetBudgetTeamReportQueryOptions = <TData = Awaited<ReturnType<typeof getBudgetTeamReport>>, TError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>>(poolId: string,
    params?: GetBudgetTeamReportParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getBudgetTeamReport>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetBudgetTeamReportQueryKey(poolId,params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getBudgetTeamReport>>> = ({ signal }) => getBudgetTeamReport(poolId,params, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: poolId !== null && poolId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getBudgetTeamReport>>, TError, TData> & { queryKey: QueryKey }
}

export type GetBudgetTeamReportQueryResult = NonNullable<Awaited<ReturnType<typeof getBudgetTeamReport>>>
export type GetBudgetTeamReportQueryError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>
...
export function useGetBudgetTeamReport<TData = Awaited<ReturnType<typeof getBudgetTeamReport>>, TError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>>(
 poolId: string,
    params?: GetBudgetTeamReportParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getBudgetTeamReport>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetBudgetTeamReportQueryOptions(poolId,params,options)
 ...
 */
export const exportProjectsCsv = async (params?: ExportProjectsCsvParams, options?: RequestInit): Promise<SpendCsvResponse> => {

  return customFetch<SpendCsvResponse>(getExportProjectsCsvUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getExportProjectsCsvQueryOptions = <TData = Awaited<ReturnType<typeof exportProjectsCsv>>, TError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>>(params?: ExportProjectsCsvParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof exportProjectsCsv>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type ExportProjectsCsvQueryError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>
...
export function useExportProjectsCsv<TData = Awaited<ReturnType<typeof exportProjectsCsv>>, TError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>>(
...
export const getGetTeamAllocationAuditUrl = (params?: GetTeamAllocationAuditParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/admin/team-budgets/audit?${stringifiedParams}` : `/api/admin/team-budgets/audit`
}
 ...
 */
export const getTeamAllocationAudit = async (params?: GetTeamAllocationAuditParams, options?: RequestInit): Promise<TeamAllocationAuditResponse> => {

  return customFetch<TeamAllocationAuditResponse>(getGetTeamAllocationAuditUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getGetTeamAllocationAuditQueryKey = (params?: GetTeamAllocationAuditParams,) => {
    return [
    `/api/admin/team-budgets/audit`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetTeamAllocationAuditQueryOptions = <TData = Awaited<ReturnType<typeof getTeamAllocationAudit>>, TError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>>(params?: GetTeamAllocationAuditParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTeamAllocationAudit>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetTeamAllocationAuditQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTeamAllocationAudit>>> = ({ signal }) => getTeamAllocationAudit(params, { signal, ...requestOptions });
...
export type GetTeamAllocationAuditQueryError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>
...
export function useGetTeamAllocationAudit<TData = Awaited<ReturnType<typeof getTeamAllocationAudit>>, TError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>>(
 params?: GetTeamAllocationAuditParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getTeamAllocationAudit>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetTeamAllocationAuditQueryOptions(params,options)
...
export const getAddTeamMonthlyAllocationUrl = (teamName: string,) => {




  return `/api/admin/team-budgets/${encodeURIComponent(String(teamName))}/allocations`
}
 ...
 */
export const addTeamMonthlyAllocation = async (teamName: string,
    teamMonthlyAllocationAddition: TeamMonthlyAllocationAddition, options?: RequestInit): Promise<TeamBudgetHistoryTeam> => {

  return customFetch<TeamBudgetHistoryTeam>(getAddTeamMonthlyAllocationUrl(teamName),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(teamMonthlyAllocationAddition)
  }
);}
...
export const getAddTeamMonthlyAllocationMutationOptions = <TError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof addTeamMonthlyAllocation>>, TError,{teamName: string;data: BodyType<TeamMonthlyAllocationAddition>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof addTeamMonthlyAllocation>>, TError,{teamName: string;data: BodyType<TeamMonthlyAllocationAddition>}, TContext> => {

const mutationKey = ['addTeamMonthlyAllocation'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof addTeamMonthlyAllocation>>, {teamName: string;data: BodyType<TeamMonthlyAllocationAddition>}> = (props) => {
          const {teamName,data} = props ?? {};

          return  addTeamMonthlyAllocation(teamName,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AddTeamMonthlyAllocationMutationResult = NonNullable<Awaited<ReturnType<typeof addTeamMonthlyAllocation>>>
    export type AddTeamMonthlyAllocationMutationBody = BodyType<TeamMonthlyAllocationAddition>
    export type AddTeamMonthlyAllocationMutationError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>

    /**
 * @summary Add a manual monthly allocation
 */
export const useAddTeamMonthlyAllocation = <TError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof addTeamMonthlyAllocation>>, TError,{teamName: string;data: BodyType<TeamMonthlyAllocationAddition>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof addTeamMonthlyAllocation>>,
        TError,
        {teamName: string;data: BodyType<TeamMonthlyAllocationAddition>},
        TContext
      > => {
      return useMutation(getAddTeamMonthlyAllocationMutationOptions(options));
    }
...
export const getListWorkspaceUsageLimitAuditsUrl = (workspaceId: string,
    params?: ListWorkspaceUsageLimitAuditsParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/directory/workspaces/${encodeURIComponent(String(workspaceId))}/usage-limit-audits?${stringifiedParams}` : `/api/directory/workspaces/${encodeURIComponent(String(workspaceId))}/usage-limit-audits`
}
 ...
 */
export const listWorkspaceUsageLimitAudits = async (workspaceId: string,
    params?: ListWorkspaceUsageLimitAuditsParams, options?: RequestInit): Promise<UsageLimitAudit[]> => {

  return customFetch<UsageLimitAudit[]>(getListWorkspaceUsageLimitAuditsUrl(workspaceId,params),
  {
    ...options,
    method: 'GET'
...
export const getListWorkspaceUsageLimitAuditsQueryKey = (workspaceId: string,
    params?: ListWorkspaceUsageLimitAuditsParams,) => {
    return [
    `/api/directory/workspaces/${workspaceId}/usage-limit-audits`, ...(params ? [params] : [])
    ] as const;
    }


export const getListWorkspaceUsageLimitAuditsQueryOptions = <TData = Awaited<ReturnType<typeof listWorkspaceUsageLimitAudits>>, TError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>>(workspaceId: string,
    params?: ListWorkspaceUsageLimitAuditsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listWorkspaceUsageLimitAudits>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListWorkspaceUsageLimitAuditsQueryKey(workspaceId,params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listWorkspaceUsageLimitAudits>>> = ({ signal }) => listWorkspaceUsageLimitAudits(workspaceId,params, { signal, ...requestOptions });
...
export type ListWorkspaceUsageLimitAuditsQueryError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>
...
export function useListWorkspaceUsageLimitAudits<TData = Awaited<ReturnType<typeof listWorkspaceUsageLimitAudits>>, TError = ErrorType<ApiError | UnauthorizedResponse | ForbiddenResponse>>(
 workspaceId: string,
    params?: ListWorkspaceUsageLimitAuditsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listWorkspaceUsageLimitAudits>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListWorkspaceUsageLimitAuditsQueryOptions(workspaceId,params,options)
...
export const getListAlertsQueryOptions = <TData = Awaited<ReturnType<typeof listAlerts>>, TError = ErrorType<UnauthorizedResponse | ForbiddenResponse | void>>(params?: ListAlertsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listAlerts>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type ListAlertsQueryError = ErrorType<UnauthorizedResponse | ForbiddenResponse | void>
...
export function useListAlerts<TData = Awaited<ReturnType<typeof listAlerts>>, TError = ErrorType<UnauthorizedResponse | ForbiddenResponse | void>>(
