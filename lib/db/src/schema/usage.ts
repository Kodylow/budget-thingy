...
// Selection checkpoints only; usage facts and successful reconciliation rows
// remain authoritative. Replaying a slice after a crash is safe.
export const ingestCursorTable = pgTable("ingest_cursor", {
