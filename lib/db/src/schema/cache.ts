import { pgTable, text, timestamp, jsonb, primaryKey, index, integer, boolean } from "drizzle-orm/pg-core";
...
export const apiProjectMetadataStateTable = pgTable("api_project_metadata_state", {
  ...
  /** True only after hasDeployment was authoritatively observed for this listing. */
  deploymentStatusObserved: boolean("deployment_status_observed").notNull().default(false),
