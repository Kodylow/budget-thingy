    ...
    return (
      <div className="flex flex-wrap items-center justify-end gap-1">
        <Input
          ...
          className="h-10 w-28 text-base font-mono sm:h-8 sm:text-sm"
    ...
    <div className="flex items-center justify-end gap-2">
      {currentBudget !== null && (
        <Button
          size="sm"
          variant="ghost"
          className="h-10 w-10 p-0 text-destructive opacity-100 sm:h-8 sm:w-8 sm:opacity-0 sm:group-hover:opacity-100 sm:focus-visible:opacity-100"
      ...
      <Button
        size="sm"
        variant="ghost"
        className="h-10 w-10 p-0 opacity-100 sm:h-8 sm:w-8 sm:opacity-0 sm:group-hover:opacity-100 sm:focus-visible:opacity-100"
