...
function HomeTeamReport({
  ...
  if (!report.isLoading && !report.isError && !hasTrajectory) return null;

  return (
    <section className="lg:col-span-2" aria-label={`${team.teamName} budget and trajectory`}>
      <BudgetTrajectory
    ...
    <div className="mx-auto max-w-[1280px] min-w-0 space-y-8 px-4 py-6 md:px-8 md:py-8">
      <section className="space-y-6">
        ...
        <div aria-label="Personal and team budgets" className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <div className={!showPersonalComparison ? 'lg:col-span-2' : undefined}>
            <PersonalBudgetPanel
          ...
          {showPersonalComparison && <Card className="rounded-md shadow-none">
