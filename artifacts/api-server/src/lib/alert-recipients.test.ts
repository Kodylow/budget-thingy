...
describe("collectAlertRecipients", () => {
  ...
  it("unions account admins, the configured operator, extras, and relevant workspace admins", () => {
    const dir = {
      groups: [],
      workspaces: new Map(),
  ...
  it("adds no implicit recipient when the bootstrap operator is unconfigured", () => {
