...
- Home's personal and team spend stories are cumulative line charts comparing the current billing cycle and two preceding cycles, aligned by cycle day. This is an intentional exception to bar charts elsewhere; missing historical data must remain visibly unavailable.
