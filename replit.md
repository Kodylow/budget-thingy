...
- Org Insights is the narrow exception to verification-gated balances: for its fixed full-term account report, a funded team's remaining/utilization is available from observed team spend even when attribution verification is incomplete. Missing team observations still produce unknown balances, and shared scoped-accounting semantics are unchanged.
