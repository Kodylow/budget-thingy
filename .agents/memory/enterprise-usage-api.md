...
- Team detail completeness is cluster-local, not workspace- or account-wide. **Why:** many unrelated groups share one Enterprise workspace; retain overlap dedup among the requested team's groups only.
