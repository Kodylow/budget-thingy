...
- Team/group detail completeness is workspace-local, not account-wide. **Why:** unrelated cold workspaces must not keep a requested custom-range detail page in a permanent loading state; retain overlap dedup within relevant workspaces.
